points = [
    ...
    {"coords": (151791.52, -29479.77, -11949.61), "label": "Withered Journal", "key": "Fellhollow_RisingDead_2"}, # certain
    ...
    {"coords": (157079.98, -57241.76, -12342.03), "label": "unkown 1", "key": ""},
...
points_b = [
    {"coords": (19773.88, 173386.00, -1209.76), "label": "", "key": ""},
    {"coords": (19694.26, 145873.62, 3183.31), "label": "", "key": ""},
    {"coords": (24370.25, 146355.36, 2999.80), "label": "", "key": ""},
    {"coords": (31204.24, 163832.16, -857.15), "label": "", "key": ""},
    {"coords": (29118.59, 156991.25, -795.24), "label": "", "key": ""},
    {"coords": (73772.44, 186935.55, 649.79), "label": "", "key": ""},
    {"coords": (68968.64, 178598.08, -344.81), "label": "", "key": ""},
    {"coords": (61409.37, 160992.44, 4280.25), "label": "", "key": ""},
    {"coords": (63040.00, 160405.00, 3415.00), "label": "", "key": ""},
    {"coords": (61445.00, 159035.00, 2935.00), "label": "", "key": ""},
    {"coords": (50467.02, 153659.06, 967.73), "label": "", "key": ""},
    {"coords": (62614.22, 172179.39, -1233.97), "label": "", "key": ""},
    {"coords": (52153.23, 172030.70, -3823.28), "label": "", "key": ""},
    {"coords": (48282.27, 177692.72, -4126.38), "label": "", "key": ""},
    {"coords": (52872.42, -47313.99, -6991.17), "label": "", "key": ""},
    {"coords": (59376.08, -48011.97, -6665.92), "label": "", "key": ""},
    {"coords": (58460.12, -46299.69, -6608.43), "label": "", "key": ""},
    {"coords": (98009.66, -29908.99, -6891.84), "label": "", "key": ""},
    {"coords": (183590.30, -71401.74, -11666.78), "label": "", "key": ""},
    {"coords": (185933.82, -31739.82, -12100.48), "label": "", "key": ""},
    {"coords": (151791.52, -29479.77, -11949.61), "label": "", "key": ""},
    {"coords": (165792.90, -50608.96, -12300.94), "label": "", "key": ""},
    {"coords": (157079.98, -57241.76, -12342.03), "label": "", "key": ""},
    {"coords": (200467.71, -74865.47, -10352.68), "label": "", "key": ""},
    {"coords": (129159.89, -64598.76, -6727.84), "label": "", "key": ""},
    {"coords": (139716.57, -56387.63, -7309.97), "label": "", "key": ""},
]

print(f"Points A: {len(points)}")
coords_a = {p["coords"] for p in points}

only_in_b = [p for p in points_b if p["coords"] not in coords_a]

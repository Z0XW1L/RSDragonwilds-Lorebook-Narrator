...
points = [
    ...
    {"coords": (24370.25, 146355.36, 2999.80), "label": "Preserved Diary", "key": "Guthix_C1"},
    {"coords": (19694.26, 145873.62, 3183.31), "label": "Vault Hunter's Journal", "key": "VaultHunterJournal"},
    ...
    {"coords": (185933.82, -31739.82, -12100.48), "label": "Ulgo's Diary", "key": "Fellhollow_Zogre_2"},
